...
class main_frame(wx.Frame):
    ...
    def __init__( self ):
        wx.Frame.__init__ ( self, None, id = wx.ID_ANY, title = u"SpatioTemporal Overlap Positioner",
                           pos = wx.DefaultPosition, size = wx.Size( 750,550 ), style = wx.DEFAULT_FRAME_STYLE^wx.RESIZE_BORDER^ wx.MAXIMIZE_BOX|wx.TAB_TRAVERSAL )
        self.create_menu()
